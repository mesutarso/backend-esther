...
export interface ApiInviteInvite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['couple', 'singleton']>;
    status: Attribute.Enumeration<['in', 'out']> & Attribute.DefaultTo<'out'>;
